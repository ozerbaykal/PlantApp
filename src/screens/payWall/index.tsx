import { FlatList, ImageBackground, Platform, TouchableOpacity, SafeAreaView, StatusBar, StyleSheet, Text, View } from 'react-native'
...
const PayWall:React.FC<PropsNavigation> = ({navigation}) => {
  const [selectedOption, setSelectedOption] = useState<'option1' | 'option2' | null>('option2');
        ...
        <SafeAreaView style={{ flex: 1 }}>
          <View style={styles.container}>
            ...
            <View style={styles.footer}>
              <Text style={styles.footerText}>After the 3-day free trial period you’ll be charged ₺274.99 per year unless you cancel before the trial expires. Yearly Subscription is Auto-Renewable</Text>
              <Text style={styles.footerSubText}>Terms  •  Privacy  •  Restore</Text>
            </View>
          </View>
        </SafeAreaView>
      </ImageBackground>
