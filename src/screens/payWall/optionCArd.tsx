  ...
  const OptionCard = ({
    ...
    const renderContent = (contentExtraProps = {}, viewExtraStyles = {}) => (
      ...
      >
        ...
        <View style={[styles.checkboxContainer, isSelected && styles.selectedCheckbox]}>
      ...
      return (
        <TouchableOpacity onPress={() => setSelected(thisOption)}>
          ...
          >
            ...
            {renderContent({ collapsable: false }, { backgroundColor: 'transparent' })}
          </LinearGradient>
        </TouchableOpacity>
      );
    }
  
    return <TouchableOpacity onPress={() => setSelected(thisOption)}>{renderContent()}</TouchableOpacity>;
  };
